...
function Q(t) {
	...
	for (let r = 0; r < n.length; r++) {
		const u = n[r].claim_order,
			s = (c > 0 && n[e[c]].claim_order <= u ? c + 1 : W(1, c, (y) => n[e[y]].claim_order, u)) - 1;
		i[r] = e[s] + 1;
		const a = s + 1;
...
function qt(t, n, e, i, c, f, l, o = [-1]) {
	...
	if (
		((u.ctx = e
			? e(t, n.props || {}, (a, y, ...k) => {
					const A = k.length ? k[0] : y;
					return (
						u.ctx &&
							c(u.ctx[a], (u.ctx[a] = A)) &&
							(!u.skip_bound && u.bound[a] && u.bound[a](A), s && ct(t, a)),
						y
					);
			  })
			: []),
		...
		n.intro && et(t.$$.fragment), it(t, n.target, n.anchor, n.customElement), K(), H();
	}
	h(r);
}
class Bt {
